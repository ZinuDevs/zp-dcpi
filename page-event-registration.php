<?php
/*
Template Name: Main Event Registration Form
*/
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['event_id'])) {
    ...
    // Here, you can process the registration and associate it with the event_id
    // Example: save to user meta or another custom field
}
